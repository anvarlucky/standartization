    ...
    <div class="container-fluid p-5">
        <div class="col-md-12 px-0 table-box">
            <div class="table-top-panel border-bottom d-flex align-items-center justify-content-between px-5 pt-5 pb-4">
                <p class="account-title mb-2">Chet el analoglari o'zgartirish oynasi</p>
            </div>
            @if(session('message'))
            ...
            <div class="form-group col-md-12">
                {{Form::open(['route' => ['foreign_analogs.update',$foreign_analog->id],'method' => 'put'])}}
                @csrf
                @include('admin.foreign_analogs._form')
